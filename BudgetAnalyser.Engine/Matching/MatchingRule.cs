...
public class MatchingRule : INotifyPropertyChanged, IEquatable<MatchingRule>
{
    ...
    public MatchingRule(IBudgetBucketRepository bucketRepository)
    {
    ...
    ///     from this value.
    /// </summary>
    internal string BucketCode { get; set; } = string.Empty;
    ...
    public bool Equals(MatchingRule? other)
    {
        ...
        return ReferenceEquals(this, other) || RuleId.Equals(other.RuleId);
    }
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj.GetType() == GetType() && Equals((MatchingRule)obj);
    }
    ...
    /// </summary>
    /// <returns>true if the rule matches the transactions</returns>
